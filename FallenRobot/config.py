class Config(object):
    ...
    DATABASE_URL = "postgres://avnadmin:AVNS_DAvZ7tSKGpfUi8Uwjxg@pg-614fb9c-barhammhamad7726-593f.i.aivencloud.com:17809/defaultdb?sslmode=require"  # A sql database url from elephantsql.com
